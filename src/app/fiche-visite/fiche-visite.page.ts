...
export class FicheVisitePage implements OnInit {
  ...
  ngOnInit() {
    this.col_fv = [
      ...
      { field: 'visit_sheet_begin_date_time' , header: 'Debut de visite', display: 'none' },
      { field: 'visit_sheet_end_date_time' , header: 'Fin de visite', display: 'none' },
      { field: 'tournee_begin' , header: '', display: 'table-cell' },
      { field: 'tournee_end' , header: '', display: 'table-cell' },
