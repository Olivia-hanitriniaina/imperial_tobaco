...
export class PageFivePage implements OnInit {
	...
	ngOnInit() {
		...
		this.cols = [ 
			{ field: 'id_product', header: '' ,display : 'none', text_align : "left"},
			{ field: 'name_product', header: 'Article' ,display : 'table-cell', text_align : "left"},
			{ field: 'quantity', header: 'Quantité étalée / remise' ,display : 'table-cell', text_align : "right"},
			{ field: 'id_manufacturer', header: '' ,display : 'none', text_align : "left"},
		];
	}
