export class res_partner {
     ...
     signup_type : string; 
     signup_expiration : Date; 
     signup_token : string; 
     team_id : number; 
     calendar_last_notif_ack : Date; 
     type_quartier_id : number; 
     source_approvisionnement_id : number; 
     cible_installation_presentoirs_id : number; 
     numero_telephone2 : string; 
     numero_telephone3 : string;
     numero_telephone1 : string;
     couverture_commerciale_id : number; 
     classification2_id : number; 
     nom_gerant : string; 
     frequence_approvisionnement_id : number; 
     enseigne_appartenance_id : number;
     agence_id : number; 
     activite_pos_id : number; 
     fournisseur_principal_id : number; 
     contrat_id : number; 
     fournisseur_secondaire_id : number;  
     nom_agent_commercial_id : number; 
     cible_activation_id : number; 
     state : string;
     statut_client_id : number; 
     permanent_POSM5_id : number; 
     point_de_vente : number	; 
     repere : string; 
     emplacement_id : number;
     cooperation_itg_id : number;  
     proximite_id : number; 
     frequence_visite_id : number; 
     permanent_POSM3_id : number; 
     permanent_POSM1_id : number; 
     adresse : string; 
     preference_animateur_id : number; 
     ...
     permanent_POSM4_id : number; 
     region_id : number; 
     nom_pos : string;   
     quartier : string;  
     ville_id : number; 
     type_client_id : number; 
     utilisateur_associe_id : number; 
     permanent_POSM2_id : number;   
     secteur_id : number; 
     provider_longitude : number;     
     code_client : string; 
     activation_autorisee_id : number; 
     is_today: number	; 
     classification1_id : number;     
	...
	constructor(name: string, company_id: number, comment: string, website: string, create_date: Date, color: number, active: number	, street: string, supplier: number	, city: string, display_name: string, zip: string, title: number, country_id: number, commercial_company_name: string, parent_id: number, company_name: string, employee: number	, ref: string, email: string, is_company: number	, fonction: string, lang: string, fax: string, street2: string, barcode: string, phone: string, write_date: Date, daty: Date, tz: string, write_uid: number, customer: number, create_uid: number, credit_limit: number, user_id: number, mobile: string, type: string, partner_share: number, vat: string, state_id: number, commercial_partner_id: number, Date_localization: Date, partner_latitude: number, partner_longitude: number, notify_email: string , message_last_post: Date, opt_out: number	, message_bounce: number, signup_type: string, signup_expiration: Date, signup_token: string, team_id: number, calendar_last_notif_ack: Date, type_quartier_id: number, source_approvisionnement_id: number, cible_installation_presentoirs_id: number, numero_telephone2: string, numero_telephone3: string, numero_telephone1: string, couverture_commerciale_id: number, classification2_id: number, nom_gerant: string, frequence_approvisionnement_id: number, enseigne_appartenance_id: number, agence_id: number, activite_pos_id: number, fournisseur_principal_id: number, contrat_id: number, fournisseur_secondaire_id: number, nom_agent_commercial_id: number, cible_activation_id: number, state: string, statut_client_id: number, permanent_POSM5_id: number, point_de_vente: number	, repere: string, emplacement_id: number, cooperation_itg_id: number, proximite_id: number, frequence_visite_id: number, permanent_POSM3_id: number, permanent_POSM1_id: number, adresse: string, preference_animateur_id: number, provider_latitude: number, zone_id: number, latitude: number , commentaire: string, longitude:  number, message_warning: string, permanent_POSM4_id: number, region_id: number, nom_pos: string, quartier: string, ville_id: number, type_client_id: number, utilisateur_associe_id: number, permanent_POSM2_id: number, secteur_id: number, provider_longitude: number, code_client: string, activation_autorisee_id: number, is_today: number	, classification1_id: number, a_visiter_moved0: string, visite: string, a_visite: number	, a_visiter: number, canal_id : number , id?: number) {
		if(id){
			this.id = id;
		}
		this.name = name;
